  ...
  return (
    <div className="h-full flex flex-col overflow-hidden text-sm">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {loadError && (
          <div className="v2-notice m-3 flex items-start gap-2 rounded-lg border border-red-500/25 bg-red-500/10 p-2 text-xs text-[var(--color-error-text)]" data-tone="error">
